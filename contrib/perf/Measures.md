...
| ID | Metric | Result | Type | Tools | Source |
|----|--------|--------|--------|-------|--------|
| M-CACHE-MATRIX | budgets + p50 | e.g. dbcache **800** off: **100/183/517** MiB; generate(100) p50 **~835 ms**; getdbinfo **~4.3 ms** | `repro` | `cli_timer` + `debug_log` | `contrib/perf/measure_dbcache_utxo.py`; ZeroStruct §4.3.4; TEST_ZERO |
