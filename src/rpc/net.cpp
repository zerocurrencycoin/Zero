...
UniValue getpeerinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"subver\": \"/Piramiden:x.y.z[-v]/\",  (string) The string version\n"
...
UniValue getdeprecationinfo(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 0 || chainparams.NetworkIDString() != "main")
        throw runtime_error(
            ...
            "  \"subversion\": \"/Ambrym:x.y.z[-v]/\",     (string) the server subversion string\n"
...
UniValue getnetworkinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "{\n"
            "  \"version\": xxxxx,                      (numeric) the server version\n"
            "  \"subversion\": \"/Piramiden:x.y.z[-v]/\",     (string) the server subversion string\n"
