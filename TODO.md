...
- [ ] **ZERO_COIN — scope split and Subsidy disposition:** **ZERO_COIN.md** = **user-observable** blockchain and node behavior plus **past and future events** (heights, dates, on-chain-visible economics, operational facts). **Exclude** implementation detail and **design/implementation rationale** (maintainers and planning).
**Subsidy.md** portions that are code-centric, “why we did X,” or enhancement planning
