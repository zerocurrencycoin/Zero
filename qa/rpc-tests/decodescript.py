...
class DecodeScriptTest(BitcoinTestFramework):
    ...
    def decoderawtransaction_asm_sighashtype(self):
        ...
        push_signature = hexlify(txSave.vin[0].scriptSig).decode('ascii')[2:(0x48*2+4)]
        ...
        rpc_result = self.nodes[0].decoderawtransaction(hexlify(txSave.serialize()).decode('ascii'))
