...
Pass-tier counts (regenerate via **`-list-csv`**): **A=10**, **B pass=28** (27 unique; `txn_doublespend` x2), **E pass=2** (**`-all`** = **40** invocations). **Bfail Debug=26** (includes `txindex.py`), **Bfail Retired=6**, **Efail=8**.
