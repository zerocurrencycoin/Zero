...
1. **Scope NEON blake2b integration for Equihash verification** (§5) — a maintained implementation exists (`BLAKE2/BLAKE2`'s `neon/` directory) but integration effort (API fit, licensing, correctness validation against known-answer vectors) hasn't been assessed.
